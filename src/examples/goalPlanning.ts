...
export class DemoWorld implements GoalPlanningWorld {
  ...
  advance(seconds: number): void {
    ...
    this.updateEntity("alice", 0.03 * seconds, 0);
    this.updateEntity("player_7", 0.02 * seconds, 0.01 * seconds);
    this.updateEntity("guide_bot", 0.01 * seconds, 0);
    this.updateEntity("vip_42", 0.008 * seconds, -0.01 * seconds);
  }
...
export class DemoNavigationPlanner implements NavigationPlanner {
...
export const createEnterThenDwellProgram = (): GoalProgram =>
  new DoInOrder(
...
export const createFollowPauseLeaveProgram = (): GoalProgram =>
  new DoInOrder(
...
export const createEscortVipProgram = (): GoalProgram =>
...
export const createCorridorWithGuideProgram = (): GoalProgram =>
  new ApplyNavigationConstraints(
    also(new NavigationConstraints(), (c) => {
...
export const createInspectWaypointsProgram = (): GoalProgram =>
  new ApplyNavigationConstraints(
    also(new NavigationConstraints(), (c) => {
...
export const createChargingLatchProgram = (): GoalProgram =>
  new DoInOrder(
...
export const createFieldHandoffProgram = (): GoalProgram =>
  new DoInOrder(
...
export const createDockWithBeaconProgram = (): GoalProgram =>
  new ApplyNavigationConstraints(
    also(new NavigationConstraints(), (c) => {
      c.keepWithinRegion = "east_corridor";
    }),
...
export const createTwoLegPatrolProgram = (): GoalProgram =>
  new DoInOrder(
...
export const createCorridorMergeProgram = (): GoalProgram =>
  new DoInOrder(
    new ApplyNavigationConstraints(
      also(new NavigationConstraints(), (c) => {
...
export const createEmergencyPathProgram = (): GoalProgram =>
  new DoInOrder(
    new CompleteWithin(seconds(40), new WhileConditionHolds(new HasLineOfSightTo("beacon1"), new MoveToRegion("egress"))),
...
export const createEscortWithHazardProgram = (): GoalProgram =>
  new ApplyNavigationConstraints(
    also(new NavigationConstraints(), (c) => {
      c.avoidRegions.add("construction_zone");
    }),
...
export const examplePrograms: Record<string, () => GoalProgram> = {
